...
<div class="card">
    <div class="card-header">
        <div class="d-flex justify-content-between align-items-center">
            <h1 class="mb-0 h3">Tambah APAR</h1>
        </div>
    </div>
    <div class="card-body">
        <div>
                ...
                <div class="row">
                    <div class="form-group mb-3 col-md-3">
                        ...
                        <input type="text" name="kode" class="form-control @error('kode') is-invalid @enderror"
                            id="kode" value="{{ old('kode') }}" placeholder="Kode APAR">
                        @error('kode')
                    ...
                    <div class="form-group mb-3 col-md-3">
                        ...
                        <input type="text" name="lokasi" class="form-control @error('lokasi') is-invalid @enderror"
                            id="lokasi" value="{{ old('lokasi') }}" placeholder="Lokasi APAR">
                        @error('lokasi')
                        <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    <div class="form-group mb-3 col-md-3">
                        ...
                        <select name="jenis_isi" class="form-control @error('jenis_isi') is-invalid @enderror">
                            ...
                            <option value="Powder" {{ old('jenis_isi') == 'Powder' ? 'selected' : '' }}>Powder</option>
                            <option value="CO2" {{ old('jenis_isi') == 'CO2' ? 'selected' : '' }}>CO2</option>
                            <option value="Foam" {{ old('jenis_isi') == 'Foam' ? 'selected' : '' }}>Foam</option>
                            <option value="HCFC" {{ old('jenis_isi') == 'HCFC' ? 'selected' : '' }}>HCFC</option>
                        </select>
                        @error('jenis_isi')
                        <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    ...
                    <div class="form-group mb-3 col-md-3">
                        ...
                        <input type="number" name="ukuran" class="form-control @error('ukuran') is-invalid @enderror"
                            id="ukuran" value="{{ old('ukuran') }}" placeholder="Ukuran APAR">
                        @error('ukuran')
                        <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="form-group mb-3 col-md-3">
                        ...
                        <input type="date" name="tgl_kadaluarsa" class="form-control @error('tgl_kadaluarsa') is-invalid @enderror"
                            id="tgl_kadaluarsa" value="{{ old('tgl_kadaluarsa') }}" placeholder="Tgl kadaluarsa APAR">
                    ...
                    <div class="form-group mb-3 col-md-3">
                        ...
                        <select name="jenis_pemadam" class="form-control @error('jenis_pemadam') is-invalid @enderror">
                            ...
                            <option value="APAR" {{ old('jenis_pemadam') == 'APAR' ? 'selected' : '' }}>APAR</option>
                            <option value="EXP" {{ old('jenis_pemadam') == 'EXP' ? 'selected' : '' }}>EXP</option>
                            <option value="APAB" {{ old('jenis_pemadam') == 'APAB' ? 'selected' : '' }}>APAB</option>
                            <option value="ADA" {{ old('jenis_pemadam') == 'ADA' ? 'selected' : '' }}>ADA</option>
                        </select>
                        @error('jenis_pemadam')
                        <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    ...
                    <div class="form-group mb-3 col-md-3">
                        ...
                        <select name="tanda" class="form-control @error('tanda') is-invalid @enderror">
                            ...
                            <option value="ADA" {{ old('tanda') == 'ADA' ? 'selected' : '' }}>ADA</option>
                            <option value="TIDAK ADA" {{ old('tanda') == 'TIDAK ADA' ? 'selected' : '' }}>TIDAK ADA</option>
                        </select>
                        @error('tanda')
                        <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    ...
                    <div class="form-group mb-3 col-md-3">
                        ...
                        <input type="text" name="catatan" class="form-control @error('catatan') is-invalid @enderror"
                            id="catatan" value="{{ old('catatan') }}" placeholder="Catatan APAR">
                        @error('catatan')
                        <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    <div class="form-group mb-3 col-md-3">
                        ...
                        <input type="date" name="tgl_refill" class="form-control @error('tgl_refill') is-invalid @enderror"
                            id="tgl_refill" value="{{ old('tgl_refill') }}" placeholder="Tgl refill APAR">
                        @error('tgl_refill')
                        <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    <div class="form-group mb-3 col-md-3">
                        ...
                        <input type="text" name="keterangan" class="form-control @error('keterangan') is-invalid @enderror"
                            id="keterangan" value="{{ old('keterangan') }}" placeholder="Keterangan APAR">
                        @error('keterangan')
                        <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
